    ...
    try {
      ...
      while (true) {
        const { data, error } = await supabase
          .from('persons')
          .select('id, client_id, first_name, last_name, nickname, date_of_birth, gender, race, ethnicity, living_situation, veteran_status, chronic_homeless, enrollment_date, case_manager')
